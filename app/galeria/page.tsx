...
const obras = [
  ...
  { slug: "monjas",    titulo: "XIV", imagen: "/obras/monjas.jpg",    tecnica: "Óleo sobre cartón",  descripcion: "Religiosas y figuras desnudas habitan mundos paralelos separados por un umbral." },
  { slug: "espejo",    titulo: "XV",  imagen: "/obras/espejo.jpg",    tecnica: "Óleo sobre cartón",  descripcion: "Una mujer de amarillo y su reflejo en un espacio surreal. La identidad y el doble en tonos verdes y ocres." },
  { slug: "calle",     titulo: "XVI", imagen: "/obras/calle.jpg",      tecnica: "Óleo sobre cartón",  descripcion: "Dos figuras avanzan por una calle de tonos azules y cálidos. El tiempo detenido de la vida ordinaria." },
  { slug: "poder",     titulo: "XVII",imagen: "/obras/poder.jpg",      tecnica: "Óleo sobre tabla",   descripcion: "Una mano gigante desciende sobre una masa de humanidad. Símbolo crudo del dominio y la pequeñez." },
  { slug: "cabinas",   titulo: "XVIII",imagen: "/obras/cabinas.jpg",    tecnica: "Óleo sobre cartón",  descripcion: "Figuras atrapadas en cabinas transparentes, un pájaro en el suelo. El absurdo kafkiano hecho pintura." },
  { slug: "medicos",   titulo: "XIX", imagen: "/obras/medicos.jpg",    tecnica: "Óleo sobre lienzo",  descripcion: "Tres figuras con bata blanca ante una mesa con especímenes. La ciencia y sus rituales en clave de misterio." },
  { slug: "exodus",    titulo: "XX",  imagen: "/obras/exodus.jpg",     tecnica: "Óleo sobre tabla",   descripcion: "Dos manos blancas y enormes flanquean una multitud en marcha con un niño. La huida, lo sagrado, el miedo." },
  { slug: "pensamiendia",titulo: "XXI",imagen: "/obras/pensamiendia.jpg",tecnica: "Óleo sobre lienzo",  descripcion: "Dos hileras de figuras coronadas de flores se miran sobre fondo dorado. El pensamiento como diálogo infinito." },
  { slug: "umbral",    titulo: "XXII",imagen: "/obras/umbral.jpg",     tecnica: "Óleo sobre lienzo",  descripcion: "Una figura desnuda se abraza a un pilar oscuro mirando al cielo. El gesto de quien está en el límite entre dos mundos." },
  { slug: "arena",     titulo: "XXIII",imagen: "/obras/arena.jpg",      tecnica: "Óleo sobre tabla",   descripcion: "Una multitud de cuerpos se agolpa en un espacio oval rosado. El rebaño, la masa, la soledad en el número." },
  { slug: "corredor",  titulo: "XXIV",imagen: "/obras/corredor.jpg", tecnica: "Óleo sobre lienzo",  descripcion: "Figuras en bata forman una fila en un corredor institucional nocturno. La burocracia como jaula." },
